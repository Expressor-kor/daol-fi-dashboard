...
function sharePointWeeklySummaryFields(summary) {
  return {
    Title: summary.week,
    rateDuration: sharePointNumber(summary.rateDuration),
    curveDuration: sharePointNumber(summary.curveDuration),
    creditDuration: sharePointNumber(summary.creditDuration),
    ktb3yRangeLow: sharePointNumber(summary.ktb3yRangeLow),
    ktb3yRangeHigh: sharePointNumber(summary.ktb3yRangeHigh),
    curveSpreadRangeLow: sharePointNumber(summary.curveSpreadRangeLow),
    curveSpreadRangeHigh: sharePointNumber(summary.curveSpreadRangeHigh),
    creditSpreadRangeLow: sharePointNumber(summary.creditSpreadRangeLow),
    creditSpreadRangeHigh: sharePointNumber(summary.creditSpreadRangeHigh),
    confidence: sharePointNumber(summary.confidence),
    rateConfidence: sharePointNumber(summary.rateConfidence),
    curveConfidence: sharePointNumber(summary.curveConfidence),
    creditConfidence: sharePointNumber(summary.creditConfidence),
...
els.weeklySummaryForm?.addEventListener("submit", async event => {
  ...
  const savedSummary = upsertWeeklySummary({
    week: data.week,
    memberId: SUMMARY_MEMBER_ID,
    rateDuration: numericInputValue(data.rateDuration),
    curveDuration: numericInputValue(data.curveDuration),
    creditDuration: numericInputValue(data.creditDuration),
    ktb3yRangeLow: numericInputValue(data.ktb3yRangeLow),
    ktb3yRangeHigh: numericInputValue(data.ktb3yRangeHigh),
    curveSpreadRangeLow: numericInputValue(data.curveSpreadRangeLow),
    curveSpreadRangeHigh: numericInputValue(data.curveSpreadRangeHigh),
    creditSpreadRangeLow: numericInputValue(data.creditSpreadRangeLow),
    creditSpreadRangeHigh: numericInputValue(data.creditSpreadRangeHigh),
    confidence: Math.round(avg(confidenceValues)),
    rateConfidence: numericInputValue(data.rateConfidence),
    curveConfidence: numericInputValue(data.curveConfidence),
    creditConfidence: numericInputValue(data.creditConfidence),
